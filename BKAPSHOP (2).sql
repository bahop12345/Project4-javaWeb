...
alter table DonHang add Status varchar(10) null
...
select * from DonHang
select id from DonHang order by 1
...
update ChiTietDonHang set NgayNhan = '2022-03-04' where MaDonHang = 19 and MaSanPham =4
...
select * from DonHang where Status = '1' or status =2 ORDER BY ngayTao DESC
select * from TaiKhoan
select * from VaiTroTaiKhoan
